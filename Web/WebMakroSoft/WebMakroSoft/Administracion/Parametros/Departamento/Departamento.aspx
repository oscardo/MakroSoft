<%@ Page Title="" Language="C#" MasterPageFile="~/Interno.Master" AutoEventWireup="true" CodeBehind="Departamento.aspx.cs" Inherits="WebMakroSoft.Administracion.Parametros.Departamento.Departamento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <br />
    Departamentos existentes<br />
    <br />
    <br />
