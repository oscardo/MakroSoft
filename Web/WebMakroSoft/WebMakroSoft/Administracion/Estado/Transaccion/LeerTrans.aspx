<%@ Page Title="" Language="C#" MasterPageFile="~/Interno.Master" AutoEventWireup="true" CodeBehind="LeerTrans.aspx.cs" Inherits="WebMakroSoft.Administracion.Estado.Transaccion.LeerTrans" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <p>
        Leer Transacciones</p>
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MakroSoftDB2ConnectionString %>" SelectCommand="SPConsultaTransaccion_select" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    </p>
