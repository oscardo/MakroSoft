<%@ Page Title="" Language="C#" MasterPageFile="~/Interno.Master" AutoEventWireup="true" CodeBehind="ActualizarVendedor.aspx.cs" Inherits="WebMakroSoft.Administracion.Estado.Vendedor.ActualizarVendedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        Actualizar Vendedor</p>
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MakroSoftDB2ConnectionString %>" SelectCommand="SPConsultaVendedores" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    </p>
</asp:Content>
