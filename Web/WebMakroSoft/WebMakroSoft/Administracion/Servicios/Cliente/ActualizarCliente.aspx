<%@ Page Title="" Language="C#" MasterPageFile="~/Interno.Master" AutoEventWireup="true" CodeBehind="ActualizarCliente.aspx.cs" Inherits="WebMakroSoft.Administracion.Servicios.Cliente.ActualizarCliente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        Actualizar Clientes</p>
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MakroSoftDB2ConnectionString %>" SelectCommand="SPConsultaClientes" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
</asp:Content>
