<%@ Page Title="" Language="C#" MasterPageFile="~/Interno.Master" AutoEventWireup="true" CodeBehind="ActualizarBodega.aspx.cs" Inherits="WebMakroSoft.Administracion.Inventario.Bodega.ActualizarBodega" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MakroSoftDB2ConnectionString %>" SelectCommand="SPConsultaBodegas" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    </p>
</asp:Content>
